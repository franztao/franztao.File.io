...
\begin{document}
\title{Survivable Virtual Network Embedding with Low Cost in the Presence of Physical Node Failures}
...
Jigang Wen$^3$, Jiannong Cao$^4$, \emph{Fellow, IEEE}, Dafang Zhang$^1$ \\
...
csjcao@comp.polyu.edu.hk, dfzhang@hnu.edu.cn}
