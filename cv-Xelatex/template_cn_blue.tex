...
%\cvline{婚姻状况}{未婚}
\section{发表作品Publish}
\cvline{本科}{专利：可信水印相机（2015SR067514）}
\section{实习经历Internship}
\cvline{2015.7-9}{深圳乐美客技术有限公司公司-技术支持\newline \tiny{SBC硬件性能测试,wiki网站技术文档编辑,管理，整理和编辑论坛相关工作}}
\cvline{2016.7}{国防科技大学-暑期学习}
\section{所获奖项Awards}
\cvline{硕士}{
...
\cvline{本科}{
2013年 湖南省程序设计竞赛程序类二等奖\newline
2013年 湖南科技大学校级优秀学生\newline
2013-2014年 两次国家励志奖学金\newline
2014年 湖南省程序设计竞赛软件三等奖\newline
2014年 湖南科技大学校级优秀班干部\newline
2014年 全国信息安全大赛三等奖\newline
2015年 湖南省优秀本科毕业生\newline }
...
\cvline{数学与算法}{精通\textbf{图论}算法，对基本算法与数据结构熟悉，数学基础夯实，如矩阵论、数论}
...
\cvline{分布式网络}{熟悉TCP/IP协议，熟悉二层三层协议，熟悉VPN、NAT、MPLS以及路由交换协议（OSPF、BGP、ISIS等路由协议）原理，并有较强的分析故障排查能力和处理经验，具备基础HCNA能力，良好的移动通信知识}
\cvline{软件定义网络}{熟悉SDN、NFV、OpenFlow协议、VXlan、ODL等网络新技术，了解其基本理念和基本原理}
\cvline{数据库}{掌握MySQL}
...
\section{其他说明Other}
\cvline{专业描述}{\textbf{硕士阶段，计算机科学与技术}：研究生一年级主要研究基础查询算法（bloomfilter），现阶段研究生二年级主要研究软件定义网络\textbf{SDN多维流表算法}，网络虚拟化NFV中虚拟网络嵌入\textbf{VNE可生存性算法}等\newline
\textbf{本科阶段，信息安全专业}：主要从事与计算机安全相关的计算机技术，研究在图像中进行数字内容认证的各种脆弱性数字水印技术，包括：水印嵌入算法，水印盲检测算法，水印不可见性、安全性与鲁棒性的平衡研究等。}
\cvline{社会实践}{本科一年级任职班级班长，本科二年级任职团支书，本科三年级至四年级任职班长，本科参加英语社团和程序设计集训队。硕士二年级任职团支部书记。}
...
\subsection{硕士}
\cventry{2015--2018}{湖南大学}{导师}{谢鲲}{}{成绩 top10}                % arguments 3 to 6 are optional
\subsection{学士}
\cventry{2011--2015}{湖南科技大学}{项目导师}{向德生}{}{成绩 top10}                % arguments 3 to 6 are optional
